...
const SideNavBar = () => {
	const dropdownMenu = [
		{
			href: "https://my.btech.edu/ics",
			name: "Student Portal",
			icon: <ImBooks className="submenu-icon" />,
		},
		{
			href: "https://btech.instructure.com/login/canvas",
			name: "Canvas",
			icon: <FaRegUser className="submenu-icon" />,
		},
		{
			href: "https://discord.com/",
			name: "Discord",
			icon: <BsDiscord className="submenu-icon" />,
		},
		{
			href: "https://github.com/",
			name: "GitHub",
			icon: <BsGithub className="submenu-icon" />,
		},
		{
			href: "https://www.figma.com/",
			name: "Figma",
			icon: <CgFigma className="submenu-icon" />,
		},
		{
